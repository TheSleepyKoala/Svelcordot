...
/** @type {string} */
const CACHE_VERSION = '1714047368|4170867445';
/** @type {string} */
const CACHE_PREFIX = 'Pong with GDScri-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Pong with GDScript.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Pong with GDScript.html","Pong with GDScript.js","Pong with GDScript.offline.html","Pong with GDScript.worker.js","Pong with GDScript.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Pong with GDScript.wasm","Pong with GDScript.pck"];
